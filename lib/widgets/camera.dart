  ...
  Widget _liveFeedBody() {
    ...
    return ColoredBox(
      ...
      child: Stack(
        ...
        children: <Widget>[
          Center(
            child: _changingCameraLens ? Center(child: const Text('Changing camera lens')) : CameraPreview(_controller!, child: widget.customPaint),
          ),
          _backButton(),
          ...
          children: [
            ...
            Container(
              ...
              child: Padding(
                ...
                child: Center(
                  child: Text('${_currentZoomLevel.toStringAsFixed(1)}x', style: TextStyle(color: Colors.white)),
                ),
              ),
            ),
          ],
        ...
        children: [
          Container(
            ...
            child: Padding(
              padding: const EdgeInsets.all(8.0),
              child: Center(
                child: Text('${_currentExposureOffset.toStringAsFixed(1)}x', style: TextStyle(color: Colors.white)),
              ),
            ),
          ),
          Expanded(
